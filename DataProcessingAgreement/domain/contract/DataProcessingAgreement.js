...
class DataProcessingAgreement extends SymboleoContract {
  constructor(serviceProvider,client,instruction) {
    ...
    this.obligations.provideDataProcessingService = new Obligation('provideDataProcessingService', this.client, this.serviceProvider, this)
  }
}
