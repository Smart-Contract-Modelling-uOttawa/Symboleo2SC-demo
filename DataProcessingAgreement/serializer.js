...
function deserialize(data) {
  ...
  const contract = new DataProcessingAgreement(object.serviceProvider,object.client,object.instruction)
  ...
  for (const key of ['requestedDataProcessing','processedData','requestedRecordOfProcessing','deliveredRecordOfProcessing','adaptedInstruction','infringementNotified','suspensionNotified','clientAgreedTermination','providerAgreedTermination','paidServiceProvider','requestedPayment']) {
  ...
  if (object.obligations.payment != null) {
    const obligation = new Obligation('payment', contract.serviceProvider, contract.client, contract)
  ...
  if (object.obligations.processData != null) {
    const obligation = new Obligation('processData', contract.client, contract.serviceProvider, contract)
  ...
  if (object.obligations.adaptInstruction != null) {
    const obligation = new Obligation('adaptInstruction', contract.serviceProvider, contract.client, contract)
  ...
  if (object.obligations.deliverProcessingRecord != null) {
    const obligation = new Obligation('deliverProcessingRecord', contract.client, contract.serviceProvider, contract)
  ...
  if (object.obligations.provideDataProcessingService != null) {
    const obligation = new Obligation('provideDataProcessingService', contract.client, contract.serviceProvider, contract)
  ...
  if (object.powers.suspendService != null) {
    const power = new Power('suspendService', contract.serviceProvider, contract.serviceProvider, contract)
  ...
  if (object.powers.suspendActiveRequest != null) {
    const power = new Power('suspendActiveRequest', contract.serviceProvider, contract.serviceProvider, contract)
